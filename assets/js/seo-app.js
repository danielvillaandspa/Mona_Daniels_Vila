    ...
    function setLang(lang){
      if(!['he','en','ar'].includes(lang)) lang='he';
      ...
      document.querySelectorAll('.lbtn').forEach(b=>b.classList.toggle('active',(b.getAttribute('onclick')||'').includes("'"+lang+"'") || b.getAttribute('href')===(lang==='he'?'/':'/index-'+lang+'.html')));
      document.querySelectorAll('[data-'+lang+']').forEach(el=>el.innerHTML=el.getAttribute('data-'+lang));
      try { localStorage.setItem('dvl',lang); } catch {};
    }
